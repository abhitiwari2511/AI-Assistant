...
const Navbar = () => {
  ...
  return (
    <nav className="absolute rounded-full bg-zinc-950/60 border-1 border-zinc-800 left-1/2 m-8 transform -translate-x-1/2 min-w-[19rem] lg:min-w-[38rem] mx-auto z-30">
      <div className="flex items-center justify-between p-1 lg:p-4">
        <div className="flex justify-center">
          <img
            ...
            className="h-8 w-8"
          />
          <div className="text-sm flex items-center lg:text-lg text-white ml-2 font-bold">AI Assistant</div>
        </div>
